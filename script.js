const data = [
    ...
    const generateItems = (items) => {
      items.forEach((item) => {
        ...
        doc.classList.add('main_product', 'mr-5','w-48','bg-white','mb-5','p-5','rounded-lg','flex','justify-between','flex-col');
        doc.innerHTML = `
        <div class="product_image  bg-white ">
                  <img
                    class="w-full f-full object-contain p-4 w-20 h-40"
                    src='${item.image}'
                    alt=""
        />
        </div>
          ...
          <div class="poduct_make text-green-700">${item.description.slice(0,100)} ...</div>
